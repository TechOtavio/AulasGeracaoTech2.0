  ...
  const fazerLogin = async (e) => {
    ...
    try {
      ...
      const resposta = await fetch('http://localhost:3000/verificarLogin', 
        { method: 'POST', headers: { "Content-Type": "application/json" }, body: JSON.stringify({ email: email, senha: senha }) })
        ...
        <div className='card p-4' style={{ width: '400px' }}>
          ...
          <form onSubmit={fazerLogin}>
            <div className='mb-3'>
              ...
              <input onChange={(e) => setEmail(e.target.value)} className='form-control' type="email" id='email' name='email' />
            </div>
